...
For IGRA radiosondes, per-level GPS is unavailable and the launch position is the station location from the IGRA metadata catalog.  For synthetic datasets (SAM LES, multifractals), \texttt{launch\_lat}/\texttt{launch\_lon} remain missing.
